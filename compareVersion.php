...
// compareVersion.php
// crewsycrews
// Реализуйте функцию compareVersion, которая сравнивает переданные версии version1 и version2. Если version1 > version2,
...
// например: 12.11. Важно понимать, что версия, это не число с плавающей точкой, это несколько чисел не связанных между собой. 
