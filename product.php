 ...
 * Product.php
 * crewsycrews
 * Реализуйте функцию product, 
 * которая сворачивает последовательность с помощью переданной функции. 
 * Последовательность задается первыми двумя аргументами.
 * Первый это начало последовательности, второй это окончание. 
 * Например, последовательность [1, 4] это 1, 2, 3, 4. 
 ...
 * Обратите внимание, что последовательность, типа [$x, $x], 
 * состоит из одного числа $x и свертке не подлежит,
 * функция в этом случае должна вернуть само число $x.
 * 'С помощью переданной функции' означает то, что мы применяем эту
 * функцию к элементам последовательности и используем ее результат, как аккумулятор (накопитель результата).
 * Примеры:
 * // f(1, 2) => 1 + 2
